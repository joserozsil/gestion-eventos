                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _context.next = 3;
                            return _user2.default.find({ deletedAt: null }).exec(function (err, list) {
                                if (err) {
                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            _context2.next = 3;
                            return _user2.default.find({ _id: req.params.id, deletedAt: null }).exec(function (err, list) {
                                if (err) {
                                    return res.status(500).send(_response2.default.handleFatalError(500, err.message));
                                } else {
                                    return res.status(200).send(_response2.default.showAll(200, list));
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 4;
                            return user.save(function (err, list) {
                                if (err) {
                                    return res.status(500).send(_response2.default.handleFatalError(500, err.message));
                                } else {
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            _context4.next = 5;
                            return _user2.default.findByIdAndUpdate(req.params.id, toUpdate, { new: true }, function (err, list) {
                                if (err) {
                                    return res.status(500).send(_response2.default.handleFatalError(500, err.message));
                                } else {
                                    return res.status(200).send(_response2.default.showAll(200, list));
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            _context5.prev = 0;
                            _context5.next = 3;
                            return _user2.default.findByIdAndUpdate(req.params.id, { deletedAt: Date.now() }, { new: true }, function (err, list) {
                                if (err) {
                                    return res.status(500).send(_response2.default.handleFatalError(500, err.message));
                                } else {
                                    return res.status(200).send(_response2.default.showAll(200, list));
